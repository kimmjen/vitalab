        ...
        <Card variant="interactive" className="h-full flex flex-col border-gray-100 dark:border-gray-700 overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-indigo-600 to-indigo-800 text-white p-5 flex justify-between items-center">
                <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-xl font-bold">{t('home.webApi.subtitle')}</h3>
                </div>
                <Badge className="text-xs">{t('home.webApi.title')}</Badge>
            </div>

            {/* 이미지 */}
            <div className="relative w-full h-56 overflow-hidden group">
                <Image
                    src="/images/web-api-preview.png"
                    alt="Web API"
                    fill
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-auto">
                    ...
                    >
                        <Link href="/api/docs">
                            ...
                            <span>{t('home.webApi.docsButton')}</span>
                        </Link>
                    </Button>
                    <Button 
                        variant="secondary" 
                    ...
                    >
                        <Link href="/api/getting-started">
                            <span>{t('home.webApi.learnMore')}</span>
            ...
            <CardFooter className="p-3 border-t border-gray-100 dark:border-gray-700 text-xs text-gray-500 dark:text-gray-400">
                <span>{t('home.webApi.version')}</span>
                <span>{t('home.webApi.rateLimit')}</span>
            </CardFooter>
        </Card>
    )
} 