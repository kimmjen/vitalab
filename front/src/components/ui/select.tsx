...
>(({ className, children, radius, variant, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(selectTriggerVariants({ radius, variant }), className)}
    {...props}
  >
    {children}
...
const SelectContent = React.forwardRef<
  ...
  SelectContentProps
>(({ className, children, position = "popper", radius, ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        selectContentVariants({ radius }),
        position === "popper" &&
...
>(({ className, children, radius, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(selectItemVariants({ radius }), className)}
    {...props}
  >
